$PBExportHeader$w_genapp_frame_bak.srw
$PBExportComments$Generated MDI Frame
forward
global type w_genapp_frame_bak from window
end type
type mdi_1 from mdiclient within w_genapp_frame_bak
end type
end forward
...
global w_genapp_frame_bak w_genapp_frame_bak
